...
export const Icons = {
  ...
  'bitcoinInProgress/28': (className: string) => (
    <SVG className={className} size="28">
      ...
      <path d="M22 8V6.125" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M22 8L24.3435 10.344" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M9.11523 13.1265L13.4619 14.2912" stroke="#454D54" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M13.1777 9.55624L13.6953 7.62439" stroke="#454D54" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M10.8477 18.2496L10.33 20.1815" stroke="#454D54" strokeLinecap="round" strokeLinejoin="round" />
      <path
  ...
  'bitcoinPaid/28': (className: string) => (
    <SVG className={className} size="28">
      ...
      <path d="M25.1667 5.66667L20.8333 10L19 8.16667" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
    </SVG>
  ),
