        ...
        <RadixScrollArea.Root type="auto">
          ...
          <RadixScrollArea.Scrollbar
            ...
            className={classNames('flex select-none overflow-hidden touch-non', {
              'rounded-2xl bg-[#F6F8F9] transition-colors duration-[160ms] ease-out hover:bg-[#EAF0F1] flex-col h-4':
                !props.hideScrollbar,
            })}
          ...
          >
            <RadixScrollArea.Thumb asChild>
              <div
                ...
                className={cn(
                  'hover:border-[#EAF0F1] hover:bg-[#73808C] border-[6px] border-[#F6F8F9] bg-[#ABB2BA] rounded-lg my-auto',
